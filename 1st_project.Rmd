...
From the graphs obtained we can assume that our model fits correctly our dataset, even though the adjusted R-squared is not very high. 
...
```{r,echo=FALSE}
# lab=c("snp1","snp2","snp3","snp4","snp5","snp6","snp7","snp8")
# datos_modelo_factor=datos_modelo
# datos_modelo_factor[lab] <- lapply(datos_modelo_factor[lab], factor)
# summary(datos_modelo_factor)
```

```{r,echo=FALSE}
# modelo3=lm(data=datos_modelo_factor, conc~.)
# summary(modelo3)
# par(mfrow=c(2,2))
# plot(modelo3)
```
